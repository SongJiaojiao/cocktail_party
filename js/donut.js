...
;(function($, undefined) {
  ...
  $.fn.drawDoughnutChart = function(data, options) {
    var $this = this,
      ...
      settings = $.extend({
        ...
        summaryNumberClass: "doughnutSummaryNumber",
          cocktailClass:"cocktail",
        cocktailImgClass: "doughnutcocktailImg",
        beforeDraw: function() {  },
    ...
    var $summaryTitle = $('<p class="' + settings.summaryTitleClass + '">' + name + '</p>').appendTo($summary);
    var $cocktailImg = $('<img class="'+settings.cocktailClass+'" src="'+selected.ck_img+'">').appendTo($summary).css({opacity: 0});
    ...
    function drawPieSegments (animationDecimal) {
      ...
      if (settings.animation && settings.animateRotate) rotateAnimation = animationDecimal;//count up between0~1
        ...
        drawCocktailImg(animationDecimal, segmentTotal);
        drawsummaryTitle(animationDecimal, segmentTotal);
...
//        textElems[0].attr("d", getHollowCirclePath(doughnutRadius, cutoutRadius));
    ...
    function drawCocktailImg(animationDecimal, segmentTotal) {
      $cocktailImg
        .css({opacity: animationDecimal})
        
    }
      
    function drawsummaryTitle(animationDecimal, segmentTotal) {
      $summaryTitle
        .css({opacity: animationDecimal});
